...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( NetworkException value)?  network,TResult Function( ServerException value)?  server,TResult Function( ParseException value)?  parse,TResult Function( UnknownException value)?  unknown,required TResult orElse(),}){
final _that = this;
switch (_that) {
case NetworkException() when network != null:
return network(_that);case ServerException() when server != null:
return server(_that);case ParseException() when parse != null:
return parse(_that);case UnknownException() when unknown != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( NetworkException value)  network,required TResult Function( ServerException value)  server,required TResult Function( ParseException value)  parse,required TResult Function( UnknownException value)  unknown,}){
final _that = this;
switch (_that) {
case NetworkException():
return network(_that);case ServerException():
return server(_that);case ParseException():
return parse(_that);case UnknownException():
return unknown(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( NetworkException value)?  network,TResult? Function( ServerException value)?  server,TResult? Function( ParseException value)?  parse,TResult? Function( UnknownException value)?  unknown,}){
final _that = this;
switch (_that) {
case NetworkException() when network != null:
return network(_that);case ServerException() when server != null:
...
return server(_that.statusCode,_that.message);case ParseException() when parse != null:
return parse(_that.message);case UnknownException() when unknown != null:
...
return server(_that.statusCode,_that.message);case ParseException():
return parse(_that.message);case UnknownException():
return unknown(_that.message);case _:
  throw StateError('Unexpected subclass');
...
class NetworkException implements AppException {
  const NetworkException({this.message = 'Check your internet connection.'});
...
class ServerException implements AppException {
  const ServerException({required this.statusCode, this.message = 'Server error.'});
...
class ParseException implements AppException {
  const ParseException({this.message = 'Could not read server response.'});
